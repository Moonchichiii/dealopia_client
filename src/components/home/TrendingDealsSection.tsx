...
const TrendingDealsSection = () => {
    return (
        <section className="bg-bgPrimary py-24 relative z-10">
            <div className="container">
                ...
                <div className="mt-12 text-center">
                    <Link
                        href="/deals"
                        className="inline-flex items-center gap-2 text-textPrimary hover:text-accentPink transition-colors font-semibold group"
                    >
                        View all deals
